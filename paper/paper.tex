...
%Many textbooks also include figures depicting the execution of binary multiplication algorithms.
%We have chosen to include with our hyper-textbook an algorithm visualization, developed for the Java Hosted Algorithm Visualization Environment (JHAVÉ).
