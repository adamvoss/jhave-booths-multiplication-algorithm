...
import exe.XMLquestionCollection;
import exe.question;


/**
 * <p><code>ShowFile</code> is a GAIGS XML Support class design to handle all writing to
 * a GAIGS XML Script file. Client classes can construct a ShowFile instance,
...
//----------- Constructors ----------------------------------------------------------------
    ...
    public ShowFile(String fileName) throws IOException {
        super(new OutputStreamWriter(new FileOutputStream(new File(fileName)), "UTF8"));      
