...
If you wish to view these annotations, or if you wish to adjust your view of the visualization in general, you can zoom in and out with the magnifying glass buttons on the bottom left, or click and drag the main screen to move it as you like.
...
When a shift operation occurs, the old values of registers A and Q are highlighted in green and blue, respectively.
The current values of A and Q are also highlighted in green and blue, with two notable exceptions: the most significant bit of Q is highlighted green, indicating its value came from register A, and Beta is highlighted blue, indicating its value came from register Q.
...
When ``Count'' is equal to 0, the algorithm finishes executing, and the final result of the multiplication is highlighted in green.
The diagrams at the top left and top right of the screen are also updated with the decimal and binary representation of the result, respectively, and highlighted in green.

\begin{figure}[h]
\centering
\includegraphics[scale=0.3]{finish.pdf}
\caption{The last snapshot of the visualization}
\end{figure}
