...
The algorithm's input generator will appear, with four text fields corresponding to the values for M, A, Q, $\beta$, and Count, and the decimal values for the multiplicand and multiplier to be used to initialize Booth's Algorithm.
...
\subsection{Starting Exercise 1}
Once you have selected the desired input values, click ``OK''.
...
\caption{An example of correct input message for Exercise 1}
\end{figure}
...
\caption{An example of incorrect input message for Exercise 2}
\end{figure}
